...
<div class="d-flex align-items-center mb-4 gap-3">
    ...
    <div class="ms-auto d-flex gap-2">
        <a href="?page=sales&action=print&id=<?= $sale['id'] ?>&autoprint=1" target="_blank" class="btn btn-sm btn-outline-primary">
        ...
        <div class="card mb-3" style="border:none;">
            <div class="card-body px-0 py-0">
                ...
                <div style="display:flex;justify-content:space-between;padding:14px 20px;border-bottom:1px solid var(--border-color);">
                    ...
                    <span style="font-weight:700;font-size:0.88rem;"><?= htmlspecialchars($sale['party_name']) ?>
                ...
                <div style="display:flex;justify-content:space-between;padding:14px 20px;border-bottom:1px solid var(--border-color);">
                    <span style="color:var(--text-muted);font-size:0.82rem;">Balance</span>
