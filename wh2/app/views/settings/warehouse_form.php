            ...
            <div class="card-body">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:10px;">
                    ...
                    <div class="user-chip">
                        ...
                        <a href="?page=warehouses&action=removeUser&warehouse_id=<?= $warehouse['id'] ?>&user_id=<?= $u['id'] ?>"
                           class="chip-remove" onclick="return confirm('Remove <?= htmlspecialchars($u['name']) ?> from this warehouse?')">
